...
function Navbar() {
  ...
  return (
    <div className='navbar w-full min-h-ful flex justify-betwe bg-white max-sm:p-2'>
      <div className={`logo w-[50%] flex items-center justify-center ${showMenu ? 'max-sm:block' : 'max-sm:w-0'}`}>
        <img src={Logo} alt='Logo' className='w-[14%] p-2 max-sm:w-[32%] max-sm:ml-20' />
      </div>
      <div className={`menu w-[50%] font-bold text-black flex items-center justify-center ${showMenu ? 'max-sm:hidden' : 'max-sm:text-[12px]'} `}>
        <NavLink to="/" className='menu-item mr-4 hover:text-[#e11d48]' activeClassName='active' >Home</NavLink>
        <NavLink to="/product" className='menu-item mr-4 hover:text-[#e11d48]' activeClassName='active'>Product</NavLink>
        <NavLink to="/update" className='menu-item mr-4 hover:text-[#e11d48]' activeClassName='active'>Update</NavLink>
        <NavLink to="/about" className='menu-item mr-4 hover:text-[#e11d48]' activeClassName='active'>About</NavLink>
        <NavLink to="/login" className='menu-item mr-4 hover:text-[#e11d48]' activeClassName='active'>Login</NavLink>
